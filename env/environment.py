...
class TradeEnv(gym.Env):
    def __init__(self, tickers, data):
        ...
        self.episode_length = config.EPISODE_LENGTH #number of trading minutes in episode

        self.num_past_states = config.NUM_PAST_STATES #number of past days that are used in state
